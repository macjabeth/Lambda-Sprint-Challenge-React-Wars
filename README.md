...
React JS is a UI library that is used to create complex, rich user interfaces. It tries to solve the problem of easily updating presentation on a webpage with changes in application state.

- [x] What does it mean to _think_ in react?

Thinking in React means breaking down your application in terms of the components that make up the whole. Think of a watch that is made of many small individual components, all intricately put together to form a finished product. _tick tick_
...
Props are immutable properties passed down to child components. It can be existing state on the parent component or any other data you wish to pass along.
...
- [x] With the server up and running, open Chrome and head over to `localhost:3000` and view your beautiful app. Maybe it's not _that_ pretty... _yet_, your goal is to ensure this project becomes a thing of beauty. Follow these steps for completing your project.
